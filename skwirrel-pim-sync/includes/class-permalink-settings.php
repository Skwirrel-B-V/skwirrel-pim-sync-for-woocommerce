...
class Skwirrel_WC_Sync_Permalink_Settings {
	 ...
	 *
	 * @return array{slug_source_field: string, slug_suffix_field: string, update_slug_on_resync: bool, manufacturer_base: string, variation_permalink_enabled: bool}
	 */
	...
	public function render_slug_source_field(): void {
		...
		?>
		<label for="skwirrel_slug_source_field"></label><select id="skwirrel_slug_source_field" name="skwirrel_slug_source_field">
