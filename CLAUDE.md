...
WordPress plugin that synchronises products from the Skwirrel PIM system into WooCommerce via a JSON-RPC 2.0 API. Written in PHP 8.1+, targeting WordPress 6.x and WooCommerce 9.6+ (tested up to 10.6).
